                ...
                <>
                    ...
                    <div className="grid-3" style={{ marginBottom: '24px' }}>
                        <div className="stat-card">
                            <span className="stat-label">{t('matchesFound', { count: data.matches.length })}</span>
                            <span className="stat-value neutral">{data.matches.length}</span>
                        </div>
                        <div className="stat-card">
                            <span className="stat-label">{t('unmatchedOut', { count: data.unmatchedOut })}</span>
                            <span className="stat-value neutral">{data.unmatchedOut}</span>
                        </div>
                        <div className="stat-card">
                            <span className="stat-label">{t('unmatchedIn', { count: data.unmatchedIn })}</span>
                                    ...
                                    <div key={key} className="card" style={{
                                        ...
                                        {fb && (
                                            <div style={{
                                                ...
                                                marginBottom: '12px', fontSize: '14px', color: 'var(--green)',
                                            }}>
                                                {fb}
                                            </div>
                                        )}
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <span style={{ fontSize: '24px', color: 'var(--text-muted)' }}>&rarr;</span>
                                                <span style={{ fontSize: '11px', color: 'var(--text-muted)' }}>
                                                    {formatTimeDiff(match.timeDiffMs, t)}
                                                </span>
                                                {match.amountDiff > 0.00000001 && (
                                                    <span style={{ fontSize: '11px', color: 'var(--yellow, #eab308)' }}>
