...
export async function registerSwagger(app: FastifyInstance) {
    await app.register(swagger, {
        openapi: {
            ...
            info: {
                title: 'DTax API',
                description: 'Open-source crypto tax calculation and portfolio management API.',
                version: '0.1.0',
            ...
            tags: [
                ...
                { name: 'transactions', description: 'Transaction CRUD and import/export' },
                { name: 'tax', description: 'Tax calculation, Form 8949, Schedule D, reconciliation' },
                { name: 'portfolio', description: 'Portfolio holdings and tax-loss harvesting' },
