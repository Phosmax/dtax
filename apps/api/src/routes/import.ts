...
const formatSchema = z.enum(['generic', 'coinbase', 'binance', 'binance_us', 'kraken', 'etherscan', 'etherscan_erc20', 'gemini', 'crypto_com', 'kucoin', 'okx', 'bybit', 'gate', 'bitget']).optional();
